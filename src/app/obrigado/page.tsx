    ...
    return (
        <div className="flex items-center justify-center">
            <header className="h-screen w-full bg flex flex-col items-center justify-center text-center px-4 sm:px-0">
                <div className="w-full max-w-lg text-my">
                    <h1 className="text-4xl jazmin font-bold mb-2">Parabéns!</h1>
                    ...
                    <div className="relative flex justify-center items-center rounded-md w-full h-9 mt-4 bg-transparent border border-my/30 overflow-hidden">
                        <div className={`absolute left-0 h-full grad-secondary`} style={barStyle}></div>
                        {barStyle.width === '100%' && (
