...
export default function Page() {
    const text = [
        ...
        },
        {
            ...
            text: [
                ...
                `O Poder do Acolhimento - você nunca sabe quem está recebendo.`,
    ...
    return (
        <div className="relative">
            <a href="https://wa.me/5542988218484?text=Ol%C3%A1%2C+quero+um+prop%C3%B3sito+forte+na+minha+vida" className="fixed bottom-4 right-4 z-10">
