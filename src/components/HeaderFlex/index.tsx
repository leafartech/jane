        ...
        <header className="bg relative h-[748px] sm:min-h-screen w-full flex justify-center">
            <div className="w-full max-w-7xl flex items-end pb-0 sm:pb-0 sm:grid sm:grid-cols-2 gap-2 sm:items-center px-4 xl:px-0" id="forms">
                <div className="flex flex-col gap-2 sm:gap-4 z-10">
                    ...
                    <p className="text-my sm:text-lg sm:font-medium inter"><strong>Você se sente perdido</strong>, sem um propósito claro de vida, lutando contra a baixa autoestima/autoconfiança e está enfrentando dificuldades para lidar com os desafios vidas? <strong>Essa aula é para você</strong>!</p>
